...
public class Part2
{
    ...
    private final static int MIN_MOVES_PER_DIRECTION = 4;
    private final static int MAX_MOVES_PER_DIRECTION = 10;
    ...
    // Dijkstra's algorithm + modifications to accomodate for the maximum and minimum steps per direction
    static int calculateShortestPath(int[][] grid) {
        ...
        while ((currentNode = minHeap.poll()) != null) {
            ...
            for (int newDir = 0; newDir < MOVES.length; newDir++) {
                ...
                if (newDirCnt > MAX_MOVES_PER_DIRECTION || (dist > 0 && newDir != dir && dirCnt < MIN_MOVES_PER_DIRECTION)) continue;
